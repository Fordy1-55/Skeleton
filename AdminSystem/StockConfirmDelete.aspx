...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Label ID="lblDeleteMsg" runat="server" Height="19px" Style="z-index: 1; left: 16px; top: 80px; position: absolute" Width="120px" Style="z-index: 1; left: 16px; top: 80px; position: absolute"></asp:Label>
        </div>
    </form>
</body>
</html>
