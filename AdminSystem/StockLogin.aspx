...
<body style="height: 651px">
    <form id="form1" runat="server">
        ...
        <asp:Button ID="btnCancel" runat="server" style="z-index: 1; left: 240px; top: 263px; position: absolute; width: 54px;" Text="cancel" height="26px" OnClick="btnCancel_Click" />
